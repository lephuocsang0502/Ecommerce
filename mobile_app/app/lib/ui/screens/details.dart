...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    ...
    StripePayment.setOptions(StripeOptions(
        publishableKey:
            "pk_test_51IreeFEi6feNVHVBpCCDOXMJwN6B7YUvN4p8kmR49kUZIldEcZqmths4wTrlJK2V4Js51S7LqFyv3X8DMPinbBGJ00cQFLa6Vz",
        merchantId: "Test",
        androidPayMode: 'test'));
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    final _order = Order(
                      ...
                      payablePrice: widget.product.price * _amount,
                      purchasedQty: _amount,
